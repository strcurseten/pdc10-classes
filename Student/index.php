            ...
            <table class="table table-hover">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="view.php?id=<?php echo $student['id']; ?>" class="btn btn-primary" name="view">View Courses</a>
                            <a href="edit.php?id=<?php echo $student['id']; ?>" class="btn btn-primary" name="edit">
                    ...
                    <script>
                        function confirmation(){
                            ...
                            if (del==true){
                                window.location.href="delete.php?id=<?php echo $student['id']; ?>";
                            }
                            return del;
                        }
                    </script>
