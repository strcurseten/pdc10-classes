            ...
            <table class="table table-hover table-borderless">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit.php?id=<?php echo $teacher['id']; ?>" class="btn btn-primary" name="edit">Update</a>
                            <a href="delete.php?id=<?php echo $teacher['id']; ?>" class="btn btn-primary" name="delete">Remove</a>
                        </td>
                    </tr>
                <?php 
                }
